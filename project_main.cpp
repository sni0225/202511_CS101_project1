...
/*
	NAME: month_vec()
	ARGUMENTS: 2D string vector tweets, string senator
	RETURNS: string vector
	PURPOSE: This function takes the 2D tweets vector and a string of senator name
	as parameters and returns a string vector of all the months in which the senator tweeted.
*/
...
/*
	...
	RETURNS: void
	PURPOSE: This function takes the 2D tweets vector and a string of senator name
	as parameters and prints a bar graph as a visual representation of the senator's tweeting frequency by month.
*/
